...
The first experiment was observing learning rate behavior in training where I created a training_log.csv to log iteration number, train loss, val loss, grad norm for lr = 1e-3. 
...
**Problem 2**: Loss curve plot turns out to be 2 flat lines.
